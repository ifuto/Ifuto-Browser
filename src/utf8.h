 ...
 *   0x3041-0x33FF: E3 b1∈[0x81,0x8F] ただし 0x3040(E3 81 80, 未収録・幅 1) は除外
 *   0x4E00-0x9FFF: E4 b1∈[0xB8,0xBF]（= [0x4E00,0x4FFF]）| E5..E9（= [0x5000,0x9FFF]）
 * E0/ED の過長・サロゲート除外はこれらの lead には非該当。 */
static inline bool if_utf8_band_w2(u8 b0, u8 b1, u8 b2) {
    if ((b2 & 0xC0) != 0x80) return false;
    if (b0 == 0xE3) return b1 >= 0x81 && b1 <= 0x8F && !(b1 == 0x81 && b2 == 0x80);
